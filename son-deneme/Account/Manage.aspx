<%@ Page Title="Hesabı Yönet" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="son_deneme.Account.Manage" %>
        ...
        <div class="col-md-12">
            <div class="form-horizontal">
                ...
                <dl class="dl-horizontal">
                    ...
                    <% } %>
                    --%>
                    <dt>Admin Paneli Giriş</dt>
                    <dd>
                        <asp:LoginView ID="LoginView1" runat="server">
                            <RoleGroups>
                                <asp:RoleGroup Roles="admin">
                                    <ContentTemplate>
                                        <a runat="server" href="~/Admin/AdminPanel.aspx">Admin Paneli</a>
                                    </ContentTemplate>
                                </asp:RoleGroup>
                            </RoleGroups>
                        </asp:LoginView>
